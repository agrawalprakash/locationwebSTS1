...
public class PurchaseRestCallsAsyncExecutor {
	...
	public void updatePurchase(Purchase purchase) {
		...
		CompletableFuture.allOf(
				CompletableFuture.supplyAsync(() -> getOrderDescription(purchase.getOrderId())).thenAccept(purchase::setOrderDescription),
				CompletableFuture.supplyAsync(() -> getPaymentDescription(purchase.getPaymentId())).thenAccept(purchase::setPaymentDescription),
				CompletableFuture.supplyAsync(() -> getUserName(purchase.getUserId())).thenAccept(purchase::setBuyerName))
				.join();
	}
	...
	public String getOrderDescription(String orderId) {
		...
		ResponseEntity<String> result = restTemplate.getForEntity(
				format("%s/orders/%s", BASE_URL, orderId), String.class);
	...
	public String getUserName(String userId) {
		...
		ResponseEntity<String> result =
				restTemplate.getForEntity(format("%s/users/%s", BASE_URL, userId),String.class);
